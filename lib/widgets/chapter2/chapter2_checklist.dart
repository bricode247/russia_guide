// lib/widgets/chapter2/chapter2_checklist.dart

import 'package:flutter/material.dart';
import 'package:russia_guide/data/chapter2/chapter2_data.dart';

class Chapter2Checklist extends StatefulWidget {
  const Chapter2Checklist({super.key});

  @override
  State<Chapter2Checklist> createState() => _Chapter2ChecklistState();
}

class _Chapter2ChecklistState extends State<Chapter2Checklist> {
  ...
  List<Widget> _buildGroupedItems() {
    ...
    for (int i = 0; i < checklistItems.length; i++) {
      ...
      final cat = item['cat']!;
      if (cat != currentCat) {
        if (currentCat.isNotEmpty) widgets.add(const SizedBox(height: 12));
        widgets.add(
          Padding(
